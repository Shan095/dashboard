...
app.layout = html.Div([
    ...
    dcc.Input(id="input_box", type="number", value=100002),
    html.Br(),
...
def update_output(client_id,education, income_type,family_status,profession,organisation, gender,
    ...
    if dff['target'].values == 'one':
        result= "This client has defaut payment history! He/She is a risky client!"
        result2=""
    elif dff['target'].values == 'zero':
        result= ""
        result2="This client has no defaut payment history."
    else:
        result= "This is not a valid client id number."
        result2="Please enter a new one."
    ...
    return result,result2,figure2,figure3,figure4
